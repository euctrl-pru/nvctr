...
- id: navigationgroupatffi_2010
  ...
  URL: 'https://www.ffi.no/en/research/n-vector/'
  issued:
    year: 2010
#    month: 07
  author:
...
[n-vector page](https://www.ffi.no/en/research/n-vector/) [@navigationgroupatffi_2010].
...
* Find the mean position (centre/midpoint) of several geographical positions ([Example 6][ex6]).
