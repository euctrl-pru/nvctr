...
[![R-CMD-check](https://github.com/euctrl-pru/nvctr/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/euctrl-pru/nvctr/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
- Find the cross track distance between a path and a position ([Example
...
<div id="ref-gade_2010" class="csl-entry">
...
<div id="ref-navigationgroupatffi_2010" class="csl-entry">
